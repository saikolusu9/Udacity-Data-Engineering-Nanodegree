...
def process_song_file(cur, filepath):
    '''
    processes the song file and inserts the song and artists records into respective table.
...
def process_log_file(cur, filepath):
    '''
    processes the log file and inserts the songplay, user and time records into respective table.
...
def process_data(cur, conn, filepath, func):
    '''
    fetches all matching files from the filepath, counts the matching files and executes the function passed on each file
